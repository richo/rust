...
define i8* @rust_try(void (i8*)* %f, i8* %env) personality i8* bitcast (i32 (...)* @rust_eh_personality_catch to i8*) {
...
define internal i8* @rust_try_inner(void (i8*)* %f, i8* %env) personality i8* bitcast (i32 (...)* @rust_eh_personality to i8*) {
